...
df = pd.read_csv("figures/data/training_params_experiment_all.csv")
df.sort_values(
...
plt.savefig("figures/images/Quarto_generated/fig-training-parameters-drop.svg")
plt.savefig("figures/images/Quarto_generated/fig-training-parameters-drop.pdf")
